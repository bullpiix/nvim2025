...
local options = {
    ...
    { label = "Opción 3", action = function() print("Ejecutando función 3") end },
    { label = "Opción 4", action = function() print("Ejecutando función 4") end },
    { label = "Opción 5", action = function() print("Ejecutando función 5") end },
...
vim.api.nvim_set_keymap("n", "c", ":lua _G.show_selection_window()<CR>", { noremap = true, silent = true })
...
-- Datos informativos
local shortcuts = {
    { key = "q", action = "Escribe 'w'" },
    { key = "w", action = "Escribe 'e'" },
    { key = "s", action = "Escribe 'c'" },
    { key = "a", action = "Escribe 'x'" },
    { key = "z", action = "Escribe 'y'" },
    { key = "x", action = "Escribe 'z'" },
    { key = "c", action = "Escribe 'a'" },
    { key = "v", action = "Escribe 'b'" },
    { key = "b", action = "Escribe 'c'" },
}

-- Función para mostrar la ventana informativa
